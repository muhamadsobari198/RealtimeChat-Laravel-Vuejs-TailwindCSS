    ...
    <div>
      ...
      <form v-if="menu==='add'" class="form" @submit.prevent="addContact" @keydown="form.onKeydown($event)">
        <label for="username"></label>
          ...
          <button v-if="form.busy" disabled class="btn btn-warning">Loading...</button>
      ...
      <div  v-for="discussion in discussions"  :key="discussion.index"  @click="selectDiscussion(discussion)" >
              <div v-if="discussion.users.length && (discussion.users[0].requests_in[0] || discussion.users[0].requests_out[0])" class="discussion" :class="discussionItemClass(discussion)" >
                    ...
                    <div  class="avatar" >
                           <img :src="'storage/'+discussion.users[0].avatar" alt="" srcset="" onerror="this.src='https://www.kindpng.com/picc/m/207-2074624_white-gray-circle-avatar-png-transparent-png.png'">
                    </div>
                    ...
                    <div class="content">
                            <div class="header">
                                ...
                                <div v-if="!discussion.pivot.contact && discussion.users[0].pivot.contact" class="status" style="display:flex"> 
